...
hp_max_power = 0.02 # heat pump max power in MW
ts_size_mwh = 1 # thermal storage size in MWh
ts_sof_init = 0.5 # initial state of fill of thermal storage
ts_eff = 0.95 # thermal storage efficiency
ts_out_max = 0.03 # thermal storage max output in MWth
ts_in_max = 0.03 # thermal storage max input in MWth
COP = 3 # heat pump COP
