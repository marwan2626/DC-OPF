...
#pl.plot_opf_results(opf_results)

all_results_opf, violation_probability_opf, violations_df_opf, overall_line_violations_opf = mc.montecarlo_analysis_with_violations(
    net,
    time_steps,
    opf_results,
...
#drcc_results = drcc.drcc_opf2(net, time_steps, const_load_heatpump, const_load_household, Bbus, df_season_heatpump_prognosis, df_heatpump, heatpump_scaling_factors_df,  max_iter_drcc=100, alpha=0.05, eta=5e-4)
drcc_results = rs.load_optim_results("drcc_opf_results.pkl") 
#pl.plot_opf_results(drcc_results)

all_results_drcc, violation_probability_drcc, violations_df_drcc, overall_line_violations_drcc = mc.montecarlo_analysis_with_violations(
    net,
    time_steps,
    drcc_results,
    const_load_household,
